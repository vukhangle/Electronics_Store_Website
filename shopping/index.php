		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Miễn ship đơn hàng trên 500.000đ</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Sale đặc biệt</h4>
						</div>
					</div>
					<h6 class="text">Tất cả mặt hàng giảm giá lên đến 20%</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Sản phẩm nổi bật</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#dienthoai" data-toggle="tab">Điện thoại</a></li>
					<li><a href="#laptops" data-toggle="tab">Laptops</a></li>
					<li><a href="#maylanh" data-toggle="tab">Máy lạnh</a></li>
					<li><a href="#camera" data-toggle="tab">Camera</a></li>
					<li><a href="#dongho" data-toggle="tab">Đồng hồ</a></li>
					<li><a href="#tivi" data-toggle="tab">Tivi</a></li>
					<li><a href="#maygiat" data-toggle="tab">Máy giặt</a></li>
					<li><a href="#tulanh" data-toggle="tab">Tủ lạnh</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					VNĐ: <?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">VNĐ: <?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>
...
<!-- **************************************KẾT THÚC PHẨN TẤT CẢ SẢN PHẨM NỔI BẬT***************************************************** -->



<!-- **************************************************** TỪNG  SẢN PHẨM NỔI BẬT ************************************ -->

					<!-- -----------đienthoai  noi bat------>

	<div class="tab-pane" id="dienthoai">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from products where category=3 and subCategory=14 or subCategory= 8 and id=22 ");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
   ...
   <!-- ***********END ĐIỆN THOẠI NỔI BẬT********* -->
		...
		<div class="tab-pane" id="laptops">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from products where category=4 and subCategory=7 or subCategory=4");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<!-- =========end laptops nổi bật================ -->
				...
				<!-- máy lạnh nổi bật -->
				<div class="tab-pane" id="maylanh">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from products where category=5 and subCategory=21  ");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
<!-- ================end máy lạnh nổi bật============ -->
				...
				<div class="tab-pane" id="camera">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from products where category=6 and subCategory=30 or subCategory=31 ");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
?>
	...
	<?php } ?>
           ...
           <!-- =================end camera nổi bật============== -->
				...
				<!-- -------------DONG HO nổi bật-------- -->
				<div class="tab-pane" id="dongho">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from products where category=24 and subCategory=33 or subCategory=34");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
	...
	<?php } ?>
				...
				<div class="tab-pane" id="tivi">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from products where category=25 and subCategory in (35,36,37) ");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
?>
	...
	<?php } ?>
					...
					<!-- -----may giat nổi bật-------->
					<div class="tab-pane" id="maygiat">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from products where category=28 and subCategory in (40,41) ");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
?>
	...
	<?php } ?>
					...
					<!-- ===================end máy giặt nổi bật ============== -->

					<!-- ----------tu lanh nổi bật---------------->
					<div class="tab-pane" id="tulanh">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from products where category=29 and subCategory in (24,25,26) ");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
?>
	...
	<?php } ?>
		...
		<!-- *********************** KẾT THÚC TỪNG SẢN PHẨM NỔI BẬT ************************************************************ -->
								<!-- +++++++++++++++++++++++++++++++++++++++++++++ -->


		<!-- ******************************************************* HIỆN SẢN PHẨM TRÊN TRANG INDEX********************************** -->
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Máy Lạnh</h3>
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													VNĐ: <?php echo htmlentities($row['productPrice']);?>
												</span>
...
?>
		...
		<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Đồng hồ</h3>
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysqli_query($con,"select * from products where category=24");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
?>
		...
		<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Tivi</h3>
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysqli_query($con,"select * from products where category=25 ");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
?>
		...
		<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Máy giặt</h3>
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysqli_query($con,"select * from products where category=28 ");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
?>
		...
		<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Tủ lạnh</h3>
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysqli_query($con,"select * from products where category=29 ");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
<!-- ************************************* KẾT THÚC HIỆN SẢN PHẨM TRÊN TRANG INDEX ******************************** -->
