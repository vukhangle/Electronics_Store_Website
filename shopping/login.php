...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="Email hoặc mật khẩu không hợp lệ!";
exit();
}
}
...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<p class="">Chào mừng bạn đến với tài khoản!</p>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Tạo tài khoản mua sắm riêng tư của bạn!</p>
...
<div class="form-group">
	...
	<span class="checkout-subtitle outer-top-xs">Đăng ký ngay hôm nay và bạn có thể:  </span>
	<div class="checkbox">
	  	<label class="checkbox">
		  	Mua sắm được những sản phẩm tốt và ưu đãi nhất!
		</label>
		<label class="checkbox">
		Theo dõi đơn hàng một cách dễ dàng!
		</label>
		<label class="checkbox">
		</label>
	</div>
