...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <input type="radio" name="paymethod" value="COD" checked="checked"> Ship COD<br /><br />
		...
		<form class="" target="_blank" enctype="application/x-www-form-urlencoded"
                          action="/xulythanhtoanmomo.php"> 
			<input type="submit" name="momo" value="Thanh toán momo" class="btn btn-danger" style="margin-top: 10px;"><br /><br />
		</form>
		</div>
		<!-- panel-body  -->
