...
<div class="control-group">
											<label class="control-label" for="basicinput">	Miêu tả</label>
											<div class="controls">
												<textarea class="span8" name="description" placeholder="Nhập miêu tả" rows="5"></textarea>
											</div>
										</div>
...
?>									
										<tr>
											...
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Bạn có chắc chắn xóa!')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
