...
<head>
	...
	<title>Cấp phát đơn đặt hàng</title>
...
?>										
										<tr>
											...
											<a href="delivered-orders.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Bạn có chắc chắn muốn xóa?')"><i class="icon-remove-sign"></i></a>
											</td>
											</tr>
