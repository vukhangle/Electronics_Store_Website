...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Nhập giá sau khi giảm" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Nhập phí vận chuyển" class="span8 tip" required>
</div>
</div>
