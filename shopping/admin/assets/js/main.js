...
var Main = function () {
    ...
    //chức năng điều chỉnh các thành phần mẫu dựa trên kích thước cửa sổ
    ...
    //chức năng điều chỉnh chiều cao Nội dung chính theo chiều cao Điều hướng chính
    ...
    //chức năng kích hoạt danh sách ToDo, nếu có
    ...
    //chức năng kích hoạt Chú giải công cụ, nếu có
    var runTooltips = function () {
        if ($(".tooltips").length) {
            $('.tooltips').tooltip();
        }
    };
    //chức năng kích hoạt Popovers, nếu có
    var runPopovers = function () {
        if ($(".popovers").length) {
            $('.popovers').popover();
        }
    };
    //chức năng cho phép một nút hoặc một liên kết mở một tab
    ...
    //chức năng mở rộng cài đặt mặc định của Accordion
    ...
    //chức năng giảm kích thước của Menu chính
    ...
    //chức năng kích hoạt các công cụ bảng điều khiển
    ...
    //chức năng kích hoạt menu cấp 3 và cấp 4
    ...
    //fchức năng kích hoạt nút Go-Top
    ...
    //chức năng để tránh đóng menu thả xuống khi nhấp chuột
    ...
    //hàm trả về tham số chuỗi truy vấn với một tên đã cho.
    ...
    //fchức năng kích hoạt Plugin iCheck
    ...
    //Bộ chức năng cho Style Selector
    ...
    //chức năng kích hoạt Ít kiểu hơn
    ...
    var runWIndowResize = function (func, threshold, execAsap) {
        //đợi cho đến khi người dùng hoàn tất việc thay đổi kích thước cửa sổ, sau đó thực hiện
        $(window).clipresize(function () {
            runElementsPosition();
        });
    };
    //chức năng lưu cài đặt người dùng
    ...
    //chức năng tải cài đặt người dùng
    ...
    //chức năng xóa cài đặt người dùng
    ...
    //chức năng khôi phục cài đặt người dùng
