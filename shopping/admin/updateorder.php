...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="30">
      <td  class="fontkink1"><b>ID đơn đặt hàng:</b></td>
...
$ret = mysqli_query($con,"SELECT * FROM ordertrackhistory WHERE orderId='$oid'");
     ...
     ?>
      ...
      <tr height="20">
      <td class="fontkink1" ><b>Ngày đặt: </b></td>
...
$st='Delivered';
   ...
   <?php }else  {
    ...
    <tr>
      ...
      <input name="Submit2" type="submit" class="txtbox4" value="Thoát khỏi cửa sổ " onClick="return f2();" style="cursor: pointer;"  /></td>
    </tr>
<?php } ?>
</table>
 </form>
