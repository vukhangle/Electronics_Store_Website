		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total last-item">Trạng thắi</th>
				</tr>
			</thead><!-- /thead -->
...
?>
				<tr>
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Theo dõi">
					Theo dõi</td>
				</tr>
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">ID đơn hàng hoặc ID email đã đăng ký không hợp lệ</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
