...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">Loại sản phẩm</h3>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									VNĐ: <?php echo htmlentities($rws['productPrice']);?>
								</span>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">VNĐ: <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">VNĐ: <?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://www.facebook.com/vukhang.09/"></a></li>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">Miêu tả</a></li>
								<li><a data-toggle="tab" href="#review">Xem</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Phản hồi của khách hàng</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Giá tiền :</b>  <?php echo htmlentities($rvw['price']);?> Star</div>
											...
											<div class="review-form">
												<div class="form-container">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Xem <span class="astk">*</span></label>
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">Sản phẩm gần đây</h3>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					VNĐ: <?php echo htmlentities($rw['productPrice']);?>			</span>
