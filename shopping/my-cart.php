...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "VNĐ:"." ".$row['productPrice']; ?></span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "VNĐ:"." ".$row['shippingCharge']; ?></span></td>
...
<div class="form-group">
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Mã pin <span>*</span></label>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Tổng cộng: <span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ""; ?> .VNĐ</span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
